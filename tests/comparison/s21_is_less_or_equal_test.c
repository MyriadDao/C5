...
START_TEST(test_is_less_or_equal_1) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(decimal1, decimal2), TEST_COMPARISON_TRUE);
}
...
START_TEST(test_is_less_or_equal_3) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(decimal1, decimal2), TEST_COMPARISON_FALSE);
}
