...
START_TEST(test_9) {
  ...
  s21_decimal expected = {{10, 0, 0, 1u << 31}};
  s21_decimal result = {0};
...
START_TEST(test_12) {
  s21_decimal value = {{123, 0, 0, 2u << 16}};

  s21_decimal expected = {{123, 0, 0, (2u << 16) | (1u << 31)}};
  s21_decimal result = {0};
...
START_TEST(test_14) {
  ...
  s21_decimal expected = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 1u << 31}};
  s21_decimal result = {0};
